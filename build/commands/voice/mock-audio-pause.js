...
exports.MockAudioPause = void 0;
const discord_js_1 = require("discord.js");
const voice_1 = require("@discordjs/voice");
const enums_1 = require("../../utils/enums");
exports.MockAudioPause = {
    ...
    async execute(interaction) {
        ...
        if (connection.state.subscription.player.state.status != voice_1.AudioPlayerStatus.Playing) {
            await interaction.reply(enums_1.MockResponses.NotPlaying);
            return;
        }
        connection.state.subscription.player.pause();
        await interaction.reply(enums_1.MockResponses.Paused);
    }
};
